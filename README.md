...
- при запуске с `-Dryrun` выполняет сухой прогон: проверяет наличие mailbox/контакта, членство в рассылках и подключение к серверам;
...
Без переноса почты будут выведены сведения о наличии mailbox/контакта, членстве в рассылках и доступности серверов.
